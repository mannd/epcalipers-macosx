...
* Addition de notes
À des fins pédagogiques ou illustratives, vous pouvez ajouter des notes textuelles à l'image. Ces notes, comme les compas, sont des ajouts temporaires. Pour obtenir une copie permanente, effectuez une capture d'écran.
...
<p><span class="figure-number">Figure 4: </span>Une note.</p>
</div>
#+END_EXPORT

** Ajouter une note
Faites un clic droit avec la souris ou un clic à deux doigts sur le touchpad pour afficher le menu contextuel. Sélectionnez l'option *Ajouter une note*. Saisissez votre texte dans la zone de texte qui apparaît. Faites un clic droit dans la zone de texte pour afficher un menu d'édition. Si vous déplacez le curseur en dehors de la zone de texte, le contour disparaît. Déplacez le curseur juste en dehors de la zone de texte et vous pourrez cliquer et faire glisser la zone de texte où vous le souhaitez.

[[../../shrd/move_note.gif]]
 #+BEGIN_EXPORT html
<div id="orgbd7a499" class="figure">
<p><span class="figure-number">Figure 5: </span>Déplacer une note.</p>
</div>
#+END_EXPORT

** Supprimer des notes
Faites un clic droit juste en dehors de la zone de texte pour afficher le menu contextuel. Sélectionnez *Supprimer la note* pour supprimer la note. Vous pouvez supprimer toutes les notes en même temps en utilisant l'élément de menu *Caliper | Supprimer toutes les notes*.
