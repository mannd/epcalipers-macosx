...
- Couleur de compas: C’est la couleur d’un compas ajouté qui est non choisi.  Cette couleur peut étre plus tard changée par un clic-droit sur le compas et puis en choisissant *Couleur de compas*.[fn:2] 
...
- Taille de la police des compas: Ajuster la taille de la police des compas.
...
- Taille de la police du texte des notes: Ajuster la taille de la police du texte des nouvelles notes.[fn:1]
- Couleur du texte des notes: Ajuster la couleur du texte des nouvelles notes.
- Largeur de la zone de texte des notes, longeur de la zone de texte des notes: Ces paramètres ajustent la taille de la zone de texte dans laquelle apparaissent les nouvelles notes.

[fn:2] Toutes les modifications apportées aux paramètres de compas s'appliquent aussi bien aux anciennes qu'aux nouveaux compas.

[fn:1] Tous les paramètres de note s'appliquent uniquement aux nouvelles notes.
