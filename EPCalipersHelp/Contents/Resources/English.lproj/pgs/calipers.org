...
* Using notes
For teaching or illustrative purposes, you can add text notes to the image.  Notes, like calipers, are just temporary additions to the image.  If you want to make a permanent copy, take a screenshot.
...
<p><span class="figure-number">Figure 4: </span>A note.</p>
</div>
#+END_EXPORT

** Adding a note
Right-click with your mouse or two-finger click on the trackpad to bring up the context menu.  Select the option *Add Note*.  Type in the text box that appears.  Right-click or two-finger click on the trackpad inside the text box to bring up an editing menu.  If you click outside the text box the outline will disappear.  Move the cursor just outside the text box and you will be able to click and drag the text box anywhere you want.

[[../../shrd/move_note.gif]]
 #+BEGIN_EXPORT html
<div id="orgbd7a499" class="figure">
<p><span class="figure-number">Figure 5: </span>Moving a note.</p>
</div>
#+END_EXPORT

** Deleting notes
Right-click just outside the text box to bring up the context menu.  Select *Delete Note* to delete the note.  You can delete all notes at the same time by using the *Caliper | Delete All Notes* menu item.
