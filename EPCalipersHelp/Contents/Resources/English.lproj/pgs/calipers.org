...
** Deleting notes
Right-click just outside the text box to bring up the context menu.  Selecte *Delete Note* to delete the note.  You can delete all notes at the same time by using the *Caliper | Delete All Notes* menu item.
