...
- Auto-position text: If selected, caliper text labels will avoid being obscured by the window edges or the caliper itself by shifting position.  For example, if a caliper text label is to the right of the caliper and the caliper gets too close to the right side of the window, it will shift over to the left of the caliper.
