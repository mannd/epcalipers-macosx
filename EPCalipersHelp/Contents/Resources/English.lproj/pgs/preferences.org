...
- Caliper color: This is the color of unselected newly added calipers.  Note that this color can be overwritten by right-clicking on a caliper and selecting *Caliper Color*.[fn:2]
...
- Note text box width, note text box height: These settings adjust the size of the text box that new notes appear in.

* Footnotes
[fn:2] All changes to caliper settings apply to both already created and new calipers. 
