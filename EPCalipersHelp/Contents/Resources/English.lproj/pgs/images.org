...
You can save a screenshot of the image including the superimposed calipers and notes by selecting *File | Export Screenshot* or by by clicking on the screenshot icon on the toolbar.  This only works if you have opened an image file in the app.  If you are in transparent window mode you must use the Mac system screenshot functions if you wish to save an image.  /Command-Shift 3/ takes a screenshot of your entire desktop.  Press /Command-Shift 4/ and then /Space/ to set up taking a screenshot of a window on the desktop.  
