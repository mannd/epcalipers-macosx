...
** Multi-page PDFs
If you load a PDF file with multiple pages, the first page will be shown initially.  You can use the *View | Previous Page* and *Next Page* menu items to change pages, or the left and right arrow keys on your keyboard.
